...
scaler=pickle.load(open(r"C:\Users\Dell\Desktop\End To End\Recession Prediction\models\standardScalar.pkl", "rb"))
model = pickle.load(open(r"C:\Users\Dell\Desktop\End To End\Recession Prediction\models\modelForPrediction.pkl", "rb"))
